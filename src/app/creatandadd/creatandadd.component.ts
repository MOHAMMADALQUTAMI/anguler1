...
@Component({
  selector: 'app-creatandadd',
  templateUrl: './creatandadd.component.html',
  styleUrls: ['./creatandadd.component.css']
})
export class CreatandaddComponent implements OnInit {

  constructor(private router: Router) { }
  // navigateToFirst() {
  //   this.router.navigate(['CreatAndAdd'])
  // }
  // navigateToSecond() {
  ...
  delete(name: string) {
   ...
   gotoCreate(){
    this.router.navigate(['/add'],{queryParams: CreatandaddComponent.caller});
   };
